...
<table  class ="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td>
            ...
            <a href="<?php print("/William/desenvolvimento_web_2/northwind_POO/Controller/ControllerFuncionarioDelete.php?id=".$oFuncionario["IDFuncionario"]) ?>" class="btn btn-primary">Excluir</a>
        </td>
    </tr>
    <?php
        endforeach;
